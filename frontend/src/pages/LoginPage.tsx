...
export function LoginPage() {
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#FFFDF8", display: "grid", placeItems: "center", px: 2, }}>
      <Paper elevation={0} sx={{ width: "100%", maxWidth: 440, border: "1px solid #E0CDBB", borderRadius: 4, overflow: "hidden", }}>
        <Box sx={{ bgcolor: "#4B2E1F", color: "#F7E8D8", px: 4, py: 4, textAlign: "center", }}>
          <Box
            component="img"
            src="/images/MonedaCrepes.png"
            alt="Crepes & Waffles"
            sx={{ width: 110, height: 110, objectFit: "contain", mb: 2, }}
          />
          ...
          <Typography sx={{ mt: 1, fontSize: 14, color: "#EAD9C9" }}>
            Inicia sesión con tu usuario de la intranet.
          </Typography>
        </Box>
